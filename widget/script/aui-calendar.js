            ...
            for (var i = startYear; i <= yearLen; i++) {
                ...
                for (var ii = startMonth; ii < 12; ii++) {
                    if (endYear == i && ii >= endMonth) {
                        ...
                        tableHtml += '</thead>';
                        tableHtml += '<tbody class="aui-calendar-body  panel" >';
                ...
                for (var col = 0; col < 7; col++) {
                    if (s >= firstDay && d <= monthLen) {
                        if (_d > d & this.options.beforeStartDateClick == false) {
                            ...
                            if (col == 0 || col == 6) {
                                html += '<td date="' + year + '-' + this._foo(month) + '-' + this._foo(d) + '" class="aui-text-33">';
                            } else {
                                html += '<td date="' + year + '-' + this._foo(month) + '-' + this._foo(d) + '" class="aui-text-33">';
                            }
                        }
                        ...
                        if (this._getToday(year, month, d)) {
                            html += '<div class="today" id="today"></div>' + d;
                        } else {
                            html += d;
                        }
                        // 农历
